...
class FastestLapBanner:
    ...
    def __init__(self, appName):
        ...
        ac.setPosition(self.nameLabel, w + 10, 8)
        ac.setFontSize(self.nameLabel, 24)
        ...
        ac.setPosition(self.lastNameLabel, w + 10, 31)
    ...
    def show(self, time, driver_name):
        ...
        ac.setText(self.lastNameLabel, driver_name.split()[-1])
